...
#
[condition][net.firstpartners.data.Cell] There is a document value with name {cell-name} =$cell : Cell(cellName=="{cell-name}")
[consequence][]Add to output table as {out-name}= $cell.setCellName("{out-name}");
