...
public class RuleflowExample {
	...
	private static final String EXCEL_OUTPUT_FILE = "war/sampleresources/DslRuleFlow/chocolate-output.xls";
	...
	public Workbook runRuleflowExample() throws IOException, DroolsParserException, ClassNotFoundException, InvalidFormatException{
