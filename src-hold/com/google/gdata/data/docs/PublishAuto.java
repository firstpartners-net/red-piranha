...
@ExtensionDescription.Default(
    ...
    localName = PublishAuto.XML_NAME)
public class PublishAuto extends ExtensionPoint {
  ...
  public static ExtensionDescription getDefaultDescription(boolean required,
    ...
    ExtensionDescription desc =
        ExtensionDescription.getDefaultDescription(PublishAuto.class);
  ...
  public boolean equals(Object obj) {
    ...
    PublishAuto other = (PublishAuto) obj;
  ...
  public String toString() {
    return "{PublishAuto value=" + value + "}";
  }
