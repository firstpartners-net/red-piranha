...
public class Rp2Servlet extends HttpServlet {
	...
	private static String URL_START="http://red-piranha.appspot.com/sampleresources/SpreadSheetServlet/";

	private static final Logger log = Logger.getLogger(Rp2Servlet.class
			.getName());

	//Tmp rules and data file names
	public static final String EXCEL_DATA_FILE = URL_START+"chocolate-data.xls";
	public static final String[] RULES_FILES = new String[] { URL_START+"log-then-modify-rules.drl" };

	public static final String KNOWLEDGE_BASE_FILE=URL_START+"log-then-modify-rules.KnowledgeBase";
