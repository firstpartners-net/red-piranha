...
public class Rp2Servlet extends HttpServlet {
	...
	public static final String EXCEL_DATA_FILE = "http://red-piranha.appspot.com/spreadsheet/chocolate-data.xls";
	public static final String[] RULES_FILES = new String[] { "http://red-piranha.appspot.com/spreadsheet/log-then-modify-rules.drl" };

	public static final String KNOWLEDGE_BASE_FILE="http://red-piranha.appspot.com/spreadsheet/log-then-modify-rules.KnowledgeBase";
